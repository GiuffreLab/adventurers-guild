...
export const EQUIPMENT_SKILLS = {
  ...
  HOLY_SMITE: {
    ...
    icon: '✝', effects: { powerMultiplier: 1.4, atkBonus: 0.35, defBonus: 0.20, maxHpBonus: 0.05 }, procChance: 0.45,
  ...
  DIVINE_JUDGEMENT: {
    ...
    icon: '⚖', effects: { powerMultiplier: 1.6, atkBonus: 0.45, defBonus: 0.30, maxHpBonus: 0.10, critBonus: 0.15 }, procChance: 0.60,
  ...
  GUARDIAN_AURA: {
    ...
    icon: '🛡', effects: { powerMultiplier: 1.4, defBonus: 0.35, maxHpBonus: 0.15, atkBonus: 0.10 }, procChance: 0.45,
  ...
  SANCTUM_BARRIER: {
    ...
    icon: '🏛', effects: { powerMultiplier: 1.6, defBonus: 0.45, maxHpBonus: 0.25, atkBonus: 0.15, critBonus: 0.05 }, procChance: 0.60,
  ...
  GUARDIAN_SLASH: {
    ...
    icon: '🛡', effects: { powerMultiplier: 1.4, atkBonus: 0.30, defBonus: 0.25, maxHpBonus: 0.05 }, procChance: 0.45,
  ...
  DIVINE_OATH: {
    ...
    icon: '✝', effects: { powerMultiplier: 1.6, atkBonus: 0.45, defBonus: 0.40, maxHpBonus: 0.15 }, procChance: 0.60,
