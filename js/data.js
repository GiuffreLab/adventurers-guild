...
export const EQUIPMENT = {
  ...
  WORN_LUTE: {
    ...
    rarity: 'common',
    classReq: ['BARD'],
    statBonus: { mag: 5, spd: 3, crit: 1, dodge: 1 },
    sellPrice: 5,
    buyPrice: 18,
    shopMinRank: 'F',
    twoHanded: true,
  ...
  SILVER_LUTE: {
    ...
    rarity: 'magic',
    classReq: ['BARD'],
    statBonus: { mag: 15, spd: 6, crit: 2, dodge: 4, def: 2 },
    sellPrice: 32,
    buyPrice: 80,
    shopMinRank: 'E',
    twoHanded: true,
  ...
  ENCHANTED_LUTE: {
    ...
    rarity: 'rare',
    classReq: ['BARD'],
    statBonus: { mag: 27, spd: 11, crit: 3, dodge: 5, def: 3 },
    sellPrice: 100,
    buyPrice: 250,
    shopMinRank: 'D',
    twoHanded: true,
  ...
  SIREN_HARP: {
    ...
    rarity: 'epic',
    classReq: ['BARD'],
    statBonus: { mag: 45, spd: 15, crit: 7, dodge: 12, maxHp: 18 },
    sellPrice: 250,
    buyPrice: 620,
    shopMinRank: 'C',
    twoHanded: true,
  ...
  ORPHEUS_LYRE: {
    ...
    rarity: 'legendary',
    classReq: ['BARD'],
    statBonus: { mag: 72, spd: 24, crit: 11, dodge: 21, maxHp: 30 },
    sellPrice: 880,
    buyPrice: 2200,
    shopMinRank: 'B',
    twoHanded: true,
  ...
  IRON_DRUM: {
    ...
    rarity: 'magic',
    classReq: ['BARD'],
    statBonus: { mag: 14, def: 5, crit: 1, dodge: 2 },
    sellPrice: 30,
    buyPrice: 75,
    shopMinRank: 'E',
    twoHanded: true,
  ...
  WAR_DRUM: {
    ...
    rarity: 'rare',
    classReq: ['BARD'],
    statBonus: { mag: 24, def: 8, crit: 2, dodge: 4, spd: 5 },
    sellPrice: 98,
    buyPrice: 245,
    shopMinRank: 'D',
    twoHanded: true,
  ...
  THUNDERDRUM: {
    ...
    rarity: 'epic',
    classReq: ['BARD'],
    statBonus: { mag: 42, def: 12, crit: 7, dodge: 11, spd: 8 },
    sellPrice: 255,
    buyPrice: 630,
    shopMinRank: 'C',
    twoHanded: true,
  ...
  DRUMS_OF_ETERNITY: {
    ...
    rarity: 'legendary',
    classReq: ['BARD'],
    statBonus: { mag: 66, def: 18, crit: 13, dodge: 20, spd: 12, maxHp: 23 },
    sellPrice: 875,
    buyPrice: 2190,
    shopMinRank: 'B',
    twoHanded: true,
  ...
  CEL_LYRE_OF_CREATION: {
    ...
    statBonus: { mag: 68, spd: 27, crit: 22, dodge: 36 },
