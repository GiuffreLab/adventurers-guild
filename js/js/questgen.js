...
const RANK_LOOT_POOLS = {
  F: ['SLIME_JELLY', 'WOLF_PELT', 'GOBLIN_EAR', 'WORN_SWORD', 'RUSTY_DAGGER', 'IRON_CLAW', 'OAK_STAFF', 'IRON_PLATE', 'CHAINMAIL', 'LEATHER_VEST', 'CLOTH_ROBES', 'LUCKY_CHARM', 'WOODEN_SHIELD', 'HUNTING_BOW', 'APPRENTICE_STAFF', 'FOCUS_ORB'],
  E: ['GOBLIN_EAR', 'WOLF_PELT', 'SKELETON_BONE', 'IRON_SWORD', 'STEEL_DAGGER', 'STEEL_CLAW', 'IRONWOOD_STAFF', 'LONGBOW', 'IRON_GREATSWORD', 'STEEL_PLATE', 'STEEL_CHAIN', 'HARDENED_LEATHER', 'MAGE_ROBES', 'MAGE_STAFF', 'SWIFT_RING', 'VITALITY_AMULET', 'IRON_SHIELD', 'CRYSTAL_ORB'],
  D: ['SKELETON_BONE', 'BANDIT_MASK', 'MANA_CRYSTAL', 'STEEL_SWORD', 'VENOM_FANG', 'TIGER_FANG', 'JADE_BO', 'STEEL_GREATSWORD', 'GALEWIND_BOW', 'TEMPLAR_PLATE', 'SHADOW_CHAIN', 'TIGER_HIDE', 'ARCANE_VESTMENTS', 'CRYSTAL_STAFF', 'DIVINE_STAFF', 'POWER_STONE', 'TOWER_SHIELD', 'VOID_ORB', 'HOLY_ORB'],
  C: ['OGRE_TOOTH', 'MANA_CRYSTAL', 'MYTHRIL_BLADE', 'SHADOW_EDGE', 'DRAGON_CLAW', 'CELESTIAL_BO', 'FLAMBERGE', 'STORMREND_BOW', 'ARCHMAGE_STAFF', 'STAFF_OF_DAWN', 'MYTHRIL_PLATE', 'MYTHRIL_CHAIN', 'DRAGON_GI', 'CELESTIAL_ROBES', 'MYTHRIL_SHIELD', 'ORB_OF_ETERNITY', 'POWER_STONE'],
  B: ['DRAGON_SCALE', 'MANA_CRYSTAL', 'MYTHRIL_BLADE', 'SHADOW_EDGE', 'DRAGON_CLAW', 'FLAMBERGE', 'STORMREND_BOW', 'ARCHMAGE_STAFF', 'STAFF_OF_DAWN', 'MYTHRIL_PLATE', 'MYTHRIL_CHAIN', 'DRAGON_GI', 'CELESTIAL_ROBES'],
  A: ['DRAGON_SCALE', 'MANA_CRYSTAL', 'MYTHRIL_BLADE', 'SHADOW_EDGE', 'DRAGON_CLAW', 'FLAMBERGE', 'STORMREND_BOW', 'ARCHMAGE_STAFF', 'STAFF_OF_DAWN', 'MYTHRIL_PLATE', 'MYTHRIL_CHAIN', 'DRAGON_GI', 'CELESTIAL_ROBES'],
