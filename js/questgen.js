...
const RANK_LOOT_POOLS = {
  F: ['WORN_SWORD', 'RUSTY_BROADSWORD', 'BLUNT_SHIV', 'RUSTY_FLAIL', 'WOODEN_MACE', 'RUSTY_DAGGER', 'WRAPPED_FIST', 'BAMBOO_STAFF', 'SHORT_BOW', 'WILLOW_WAND', 'WORN_LUTE', 'CRACKED_DRUM', 'BLIGHTED_WAND', 'RUSTY_SCYTHE', 'RUSTY_MAIL', 'LIGHT_CHAIN', 'THIN_VEST', 'ROUGH_TUNIC', 'TATTERED_ROBES', 'WOOL_ROBES', 'WOODEN_BUCKLER', 'LEATHER_QUIVER', 'GLASS_ORB', 'WOODEN_ORB', 'CRACKED_SKULL', 'LEATHER_BAND', 'WOODEN_CHARM', 'CRYSTAL_SHARD', 'BLESSED_TOKEN'],
  E: ['IRON_SWORD', 'IRON_BROADSWORD', 'IRON_GREATSWORD', 'IRON_FLAIL', 'IRON_MACE', 'STEEL_DAGGER', 'IRON_CLAW', 'OAK_STAFF', 'HUNTING_BOW', 'APPRENTICE_STAFF', 'BLESSED_STAFF', 'SILVER_LUTE', 'IRON_DRUM', 'BONE_STAFF', 'BONE_SCYTHE', 'HEAVY_MAIL', 'PADDED_CHAIN', 'LEATHER_VEST', 'CLOTH_ROBES', 'BLESSED_ROBES', 'MONKS_ROBE', 'WOODEN_SHIELD', 'IRON_BUCKLER', 'HUNTERS_QUIVER', 'FOCUS_ORB', 'BLESSED_ORB', 'TOME_OF_SHADOWS', 'LUCKY_CHARM', 'SWIFT_RING', 'POWER_RING', 'MANA_RING', 'WARD_RING', 'IRON_AMULET', 'VITALITY_PENDANT'],
  D: ['STEEL_SWORD', 'STEEL_BROADSWORD', 'STEEL_GREATSWORD', 'STEEL_FLAIL', 'STEEL_MACE', 'VENOM_FANG', 'STEEL_CLAW', 'HARDWOOD_BO', 'COMPOSITE_BOW', 'MAGE_STAFF', 'CRYSTAL_STAFF', 'ENCHANTED_LUTE', 'WAR_DRUM', 'HEXWOOD_STAFF', 'GRAVE_REAPER', 'IRON_PLATE', 'FORTRESS_PLATE', 'CHAINMAIL', 'REINFORCED_CHAIN', 'HARDENED_LEATHER', 'MAGE_ROBES', 'WARD_ROBES', 'IRON_SHIELD', 'TOWER_SHIELD', 'WINDRUNNER_QUIVER', 'CRYSTAL_ORB', 'HOLY_ORB', 'WHISPERING_SKULL', 'VITALITY_AMULET', 'POWER_STONE', 'WARRIOR_PENDANT', 'ARCANE_PENDANT', 'HOLY_PENDANT'],
  C: ['MYTHRIL_BLADE', 'GUARDIAN_BLADE', 'FLAMBERGE', 'TEMPLARS_FLAIL', 'BLESSED_MACE', 'SHADOW_EDGE', 'DRAGON_CLAW', 'CELESTIAL_BO', 'STORMREND_BOW', 'ARCHMAGE_STAFF', 'DIVINE_STAFF', 'SIREN_HARP', 'THUNDERDRUM', 'STAFF_OF_WHISPERS', 'SOUL_HARVESTER', 'TEMPLAR_PLATE', 'STEEL_PLATE', 'SHADOW_CHAIN', 'STEEL_CHAIN', 'ADAMANT_CHAIN', 'TIGER_HIDE', 'STONE_SKIN_VEST', 'ARCANE_VESTMENTS', 'SANCTIFIED_VESTMENTS', 'TOWER_SHIELD', 'SPIKED_SHIELD', 'SHADOWSTRIKE_QUIVER', 'VOID_ORB', 'GRIMOIRE_OF_SOULS'],
  B: ['EXCALIBUR', 'OATHKEEPER', 'RAGNAROK', 'JUDGEMENT', 'SANCTUM_HAMMER', 'DEATHS_WHISPER', 'ASURA_CLAW', 'RUYI_JINGU', 'ARTEMIS_BOW', 'STAFF_OF_AGES', 'STAFF_OF_DAWN', 'ORPHEUS_LYRE', 'DRUMS_OF_ETERNITY', 'DEATHRATTLE_STAFF', 'ABYSSAL_SCYTHE', 'MYTHRIL_PLATE', 'ADAMANTINE_PLATE', 'DRAGON_PLATE', 'PHANTOM_CHAIN', 'CELESTIAL_CHAIN', 'MYTHRIL_CHAIN', 'DRAGON_GI', 'NIRVANA_SHROUD', 'CELESTIAL_ROBES', 'ROBES_OF_ETERNITY', 'MYTHRIL_SHIELD', 'AEGIS', 'WALL_OF_AGES', 'GALE_QUIVER', 'ORB_OF_ETERNITY', 'ORB_OF_CREATION', 'SKULL_OF_THE_DAMNED', 'AMULET_OF_FURY', 'AMULET_OF_AGES', 'AMULET_OF_ARCANA', 'AMULET_OF_GRACE'],
  A: ['EXCALIBUR', 'OATHKEEPER', 'DEATHS_WHISPER', 'RAGNAROK', 'ARTEMIS_BOW', 'STAFF_OF_AGES', 'ORPHEUS_LYRE', 'DEATHRATTLE_STAFF', 'ABYSSAL_SCYTHE', 'DRAGON_PLATE', 'ADAMANTINE_PLATE', 'PHANTOM_CHAIN', 'DRAGON_GI', 'CELESTIAL_ROBES', 'AEGIS', 'GALE_QUIVER', 'ORB_OF_ETERNITY', 'SKULL_OF_THE_DAMNED', 'AMULET_OF_FURY', 'AMULET_OF_ARCANA'],
  S: [
