...
export const CLASSES = {
  HERO: {
    ...
    description: 'Versatile leader. Buffs the party, specializes at L10.',
  ...
  KNIGHT: {
    ...
    description: 'Iron wall. Intercepts hits for allies, massive HP and DEF.',
    baseStats: { maxHp: 160, atk: 10, def: 16, spd: 7, mag: 0, crit: 1, dodge: 2 },
    growthRates: { maxHp: 28, atk: 1.8, def: 3.0, spd: 1.0, mag: 0.0, crit: 0.2, dodge: 0.3 },
    recruitCost: true, unlockRank: null,
  },
  MAGE: {
    id: 'MAGE', label: 'Mage', sigil: 'MAG',
    description: 'Glass cannon. AoE magic destruction, Arcane Construct pet.',
  ...
  ROGUE: {
    ...
    description: 'Burst damage king. Crits, poison DoTs, fastest in the game.',
  ...
  CLERIC: {
    ...
    description: 'Sustain anchor. Heals, revives, and shields the party.',
    baseStats: { maxHp: 100, atk: 6, def: 10, spd: 8, mag: 12, crit: 2, dodge: 4 },
    growthRates: { maxHp: 15, atk: 0.8, def: 1.8, spd: 1.1, mag: 2.0, crit: 0.3, dodge: 0.6 },
    recruitCost: true, unlockRank: null,
  },
  RANGER: {
    id: 'RANGER', label: 'Ranger', sigil: 'RNG',
    description: 'Ranged AoE DPS. Precision strikes, party utility, best farmer.',
  ...
  BARD: {
    ...
    description: 'Party force multiplier with dual identity. Lute: Songweaver healing amp. Drums: Wardrum debuff specialist.',
  ...
  MONK: {
    ...
    description: 'Reactive counter-fighter. Balanced stats, 1H aggro or 2H deflect.',
  ...
  NECROMANCER: {
    ...
    description: 'Summoner with dual identity. 1H: drain caster with lifetap sustain. 2H scythe: Death Lord empowering thralls.',
